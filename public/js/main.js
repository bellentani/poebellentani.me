...
window.addEventListener("load", function () {
  setTimeout(function () {
    var firstLineText = new SplitText("#first-line", {
      type: "words,chars"
    });
    var secondLineText = new SplitText("#second-line", {
      type: "words,chars"
    });
    ...
    secondLineTimeLine.staggerFrom(secondLineChars, 0.6, {
      scale: 4,
      autoAlpha: 0,
      rotationX: -180,
    ...
    firstLineTimeline.staggerFrom(firstLineChars, 0.8, {
      opacity: 0,
      scale: 0,
      y: 80,
      rotationX: 180,
...
var body = document.querySelector(['body']); // Get the offset position of the navbar
...
var clientsDivHeight = document.querySelector('[data-section="clients"]').clientHeight; // window.addEventListener('resize', function (e) {
...
new ScrollMagic.Scene({
  triggerElement: "[data-section='banner']",
  duration: bannerDivHeight
}).setClassToggle('#home-link', "active").addTo(controller);
new ScrollMagic.Scene({
  triggerElement: "[data-section='about']",
  duration: aboutDivHeight + servicesDivHeight
}).setClassToggle('#about-link', "active").addTo(controller); // new ScrollMagic.Scene({ triggerElement: "[data-section='services']", duration: servicesDivHeight })
...
}).setClassToggle("#about .align-items-center > *", "bounceIn").addTo(controller);
new ScrollMagic.Scene({
  triggerElement: ".service__item"
}).setClassToggle(".service__icon", "bounceIn").addTo(controller);
new ScrollMagic.Scene({
