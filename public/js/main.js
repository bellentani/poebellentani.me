...
forEach(imageBg, function (index, value) {
  ...
  var imageName = imageBg[index].childNodes[1].src; //console.log(imageName, imageBg, 'antes');

  imageBg[index].classList.add('bg-img-invisible');
  imageBg[index].style.backgroundImage = 'url("' + imageName + '")'; //console.log(imageName, 'depois');
});

function setBgImg(i) {} // for (i = 0; i < divs.length; ++i) {
